...
import 'package:affix_web/screen/e-warranty/ui/dialog_link_to_google.dart';
                                      ...
                                      onPressed: () async {
                                        ...
                                        if (_editable == false) {
                                          if (_inputName.text.isEmpty ||
                                            ...
                                            showErrorSnackBar(
                                                '${AppLocalizations.of(context).translate('err-update-information')}');
                                          } else {
                                            await updateUser(
                                              context: context,
                        ...
                        _isGoogle == false
                            ? SignInButton(
                                _isDarkMode == true
                                    ...
                                    : Buttons.GoogleDark,
                                onPressed: () async {
                                  String userName = Provider.of<UpdateUI>(
                                          context,
                                          listen: false)
                                      .userName;
                                  await linkToGoogle(context).then((value) {
                                    setState(() {
                                      _reloading = true;
